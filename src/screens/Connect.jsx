...
export default function Connect() {
  ...
  function renderInstructions() {
    const StepsBlock = (
      <>
        <h3 style={styles.h3}>☑️ Check steps after you do them ⤵️</h3>
            ...
            <label style={styles.label}>
              ...
              {platform === "ios" ? (
                ...
                <>
                  ...
                  <b>"Always connect"</b> or <b>"Connect anyway"</b>.
                </>
              )}
            </label>
          </li>
...
input[type="checkbox"][style]::after {
  content:""; position:absolute; top:2px; left:6px; width:6px; height:11px;
  border:solid #000; border-width:0 3px 3px 0; transform:rotate(45deg); opacity:0;
}
